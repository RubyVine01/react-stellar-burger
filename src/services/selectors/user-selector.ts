...
export const getIsAuthChecked = (state: RootState) => state.userProfile.isAuthChecked;

// Register
export const getErrorRegister = (state: RootState) => state.userProfile.errorRegister;
...
export const getIsLoadingLogin = (state: RootState) => state.userProfile.isLoadingLogin;

// UpdateUser
export const getErrorUpdateUser = (state: RootState) => state.userProfile.errorUpdateUser;
